      ...
      <div class="login-box-body">
        ...
        <form action="{{ route('marchent.login.attempt') }}" method="post">
          ...
          <div class="form-group has-feedback">
            <input type="text" name="phone" class="form-control" placeholder="মোবাইল নম্বর">
          </div>
          <div class="form-group has-feedback">
          ...
          <div class="row">
            ...
            <!-- /.col -->
            <div class="col-xs-4">
              <button type="submit" class="btn btn-primary btn-block btn-flat">লগইন</button>
            </div>
            <!-- /.col -->
          </div>
        </form>
        ...
        <a href="#">পাসওয়ার্ড ভুলে গেছেন?</a><br>
